...
const jsonFiles = [
  ...
  "pages/admin-dashboard/admin-dashboard.json",
  "pages/admin-provider/admin-provider.json",
  "pages/admin-config/admin-config.json",
  "pages/admin-operations/admin-operations.json",
...
const jsFiles = [
  ...
  "pages/admin-provider/admin-provider.js",
  "pages/admin-config/admin-config.js",
  "pages/admin-operations/admin-operations.js",
...
const required = [
  ...
  "pages/admin-provider/admin-provider.js",
  "pages/admin-provider/admin-provider.json",
  "pages/admin-provider/admin-provider.wxml",
  "pages/admin-provider/admin-provider.wxss",
  "pages/admin-config/admin-config.js",
  "pages/admin-config/admin-config.json",
...
if (
  ...
  || !adminJs.includes("modelActionTarget")
