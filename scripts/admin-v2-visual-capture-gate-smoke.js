...
try {
  ...
  const manifest = { schemaVersion: 1, fixtureId: gate.FIXTURE_ID, renderer: "wechat-devtools-simulator", viewport: capture.VIEWPORT, states: capture.STATE_IDS.slice(), captures };
