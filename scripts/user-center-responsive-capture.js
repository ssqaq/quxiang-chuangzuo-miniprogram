...
const routes = [
  { id: "user-center", hash: "#user-center", required: [".profile-card", ".balance-card", ".quick-grid", ".account-panel"], text: ["立即充值", "收支记录"] },
  { id: "recharge", hash: "#recharge", required: [".recharge-balance", ".package-grid", ".channel-list", ".pay-button"], text: ["本次预计到账", "仅支持微信支付", "微信支付"] },
  { id: "records", hash: "#records", required: [".record-summary", ".record-tabs", ".records-panel"], text: ["全部", "充值", "消费", "奖励", "退款"] }
];
