...
assert.ok(indexJs.includes("scrollToGenerationResults()"));
assert.ok(indexJs.includes('query.select("#generation-results")'));
assert.ok(indexJs.includes("wx.pageScrollTo({"));
